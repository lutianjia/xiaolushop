<?php
namespace App\Http\Controllers\qq_connect;
use qq_connect\Recorder;
use qq_connect\URL;
...
class Oauth{
    ...
    function __construct(){
        $this->recorder = new \App\Http\Controllers\qq_connect\Recorder();
        $this->urlUtils = new \App\Http\Controllers\qq_connect\URL();
        $this->error = new \App\Http\Controllers\qq_connect\ErrorCase();
    }
